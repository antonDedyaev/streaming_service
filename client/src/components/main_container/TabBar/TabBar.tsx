...
const TabBar: FC = () => {
    ...
    return (
        <div className={styles.container} data-testid={'tabBar'}>
            <div className={styles.container__tabBar}>
                <TabBarLinkUI
                    selected={asPath === '/' ? true : false}
                    href="https://www.ivi.ru/"
                    icon={homeIcon}
                    text="Мой Иви"
                />
                <TabBarLinkUI
                    selected={asPath === '/movies' ? true : false}
                    href="/movies"
                    icon={catalogueIcon}
                    text="Каталог"
                />
                <TabBarLinkUI
                    selected={'ivi_search' in query ? true : false}
                    href={`${asPath}?ivi_search`}
                    icon={magnifyingGlass}
                    text="Поиск"
                />
                <TabBarLinkUI
                    selected={pathname === '/tvplus' ? true : false}
