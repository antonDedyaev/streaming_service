...
import phoneIcon from '../../../public//icons/link_icons/phone.svg';
import loudspeaker from '../../../public//icons/link_icons/loudspeaker.svg';
...
const Footer: FC = () => {
    ...
    return (
        <footer className={styles.iviFooter}>
            <div className={styles.iviFooter__container}>
                <div className={styles.iviFooter__container_inner}>
